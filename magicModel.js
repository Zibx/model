...
module.exports = (function () {
    ...
    var proto = Model.prototype = {
        ...
        extend: function (data) {
            // TODO определится с логикой наследования
            return new ExtendedModel(data?data:this.data.constructor(), this);
        },
        deep: function (name) {
    ...
    ExtendedModel.prototype.get = function (name) {
        ...
        return my || this.parent.get(name);
    };
    ExtendedModel.prototype.on = function (path, fn, type) {
        /* TODO rewrite this */
        this.parent.on(path, fn, type);
